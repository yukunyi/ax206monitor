...
MetricsRenderSender 现在支持通过 Libre Hardware Monitor 的 HTTP API 获取 Windows 系统的硬件监控数据，包括：
...
- [MetricsRenderSender 项目主页](https://github.com/yukunyi/metrics_render_sender)
